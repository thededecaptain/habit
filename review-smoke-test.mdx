---
title: Pre-submission smoke test
description: Manual and automated checks before submitting Habit to the Shopify App Store.
---
...
<Steps>
  <Step title="Install and billing">
  ...
  <Step title="Program settings">
    ...
    3. Set an optional notification webhook URL (use [webhook.site](https://webhook.site) for a one-off test).
  </Step>
  ...
  <Step title="Cancel and uninstall">
...
See `listing/APP_STORE_LISTING.md` in the repo for full listing copy.
